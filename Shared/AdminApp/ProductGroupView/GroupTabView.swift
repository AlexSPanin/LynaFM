            ...
            List {
                ForEach(0..<viewModel.cards.count, id: \.self) { index in
                    Button {
                        ...
                        let image = viewModel.cards[index].image
                        let description = viewModel.cards[index].label.isEmpty ? "" : " - " + viewModel.cards[index].label
                        let label = viewModel.cards[index].name + description
                        HStack(spacing: 2) {
